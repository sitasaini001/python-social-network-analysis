...
Implement a friend-suggestion algorithm by analyzing mutual connections within the social graph.
...
**Modules**                                                        
1 **Welcome Sam Altman to Bangalore**
Set the stage with a narrative-driven intro to Bangalore's tech ecosystem and the data collection mission ahead.

2 **Data Collection in Indiranagar**
Simulate real-world data scraping and collection techniques focused on a specific neighborhood's coding community.

3 **Parsing Data in Pure Python** 
Build a custom data parser from scratch — no external libraries — to process raw collected data into                                                             structured records.

4 **Finding People with Max Posts and Followers**  
Identify the most influential users on the platform by ranking them across post count and follower metrics.

5 **Finding People with Max Posts, Followers and Categories**         
Identify the most influential users on the platform by ranking them across post count and follower metrics.
